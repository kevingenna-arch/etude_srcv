...
charger_men <- function(path, annee) {
  ...
  d %>% transmute(
    ...
    # ZEAT recodée et étiquetée comme partout ailleurs (00_utils.R). Les vagues
    # FPR n'ont aucune non-réponse : pas de modalité "Non renseigne" ici.
    zeat     = recode_zeat(ZEAT),
