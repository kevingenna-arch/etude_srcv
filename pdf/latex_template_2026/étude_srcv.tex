...
\begin{table}[h!]
	...
	\begin{threeparttable}
		...
		\begin{tablenotes}[flushleft]\scriptsize
			...
			\item \textit{Millésimes} : trois points d'étape, 2014, 2018 et 2025 ; 2022 et 2023, affectés par l'anomalie de pondération
			documentée en annexe \ref{annexe3}, ne sont pas retenus.
...
\begin{table}[htbp]
	...
	\begin{threeparttable}
		...
		\begin{tablenotes}[flushleft]\scriptsize
			...
			vagues empilées. Panneau B : 2010 et 2025, couples sans enfant du même champ (femme de 15 à
			49 ans), « sans enfant » signifiant qu'aucun enfant ne vit dans le ménage.
...
\noindent Cette forme a une conséquence directe pour la suite de l'étude, et le panneau B du tableau la donne : une surface \textit{moyenne} peut rester parfaitement stable pendant que la part des ménages situés \textit{sous} le seuil augmente. C'est exactement ce qui s'est produit. La part des couples sans enfant logés dans moins de 50 m$^2$ est passée de 15,1\,\% en 2010 à 19,1\,\% en 2025, quatre points de plus, pendant que les tranches intermédiaires se vidaient et que le haut de la distribution s'étoffait légèrement. La distribution s'est polarisée sans que sa moyenne bouge. Ces couples sans enfant ne sont pas, pour l'essentiel, de jeunes ménages en début de parcours : leur âge moyen est de 31 à 32 ans, quatre à cinq sur dix sont propriétaires et leur surface médiane est de 72 m$^2$, de sorte que moins de 50 m$^2$ ne loge qu'un couple sans enfant sur cinq ; la hausse de cette part se retrouve à tous les âges de la femme, y compris entre 40 et 49 ans. Nous verrons au §\ref{sec:decompo} que ce point de spécification change d'un facteur dix l'ampleur du canal « surface » dans la décomposition finale. \\
...
\begin{table}[htbp]
	...
	\begin{threeparttable}
		...
		\begin{tablenotes}[flushleft]\scriptsize
			...
			diffèrent de moins d'un demi-point.
